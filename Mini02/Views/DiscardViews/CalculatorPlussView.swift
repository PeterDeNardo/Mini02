...
//        lblTETitle.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 14,
//                                             lblText: "Tempo Gasto",
//                                             textColor: .black,
//                                             alingnment: .left,
//                                             alpha: 0.8)
...
//        lblTEDuration.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 14,
//                                                lblText: "Duração",
//                                                textColor: .black,
//                                                alingnment: .left,
//                                                alpha: 0.6)
...
//        txtTEDuration.setTextField(fontType: .one,
//                                   fontSize: 18,
//                                    lblText: "1 Semana",
//                                    textColor: .workBlue,
//                                    alingnment: .rigth,
...
//        lblTEDaysWork.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 12,
...
//        txtTEDaysWork.setTextField(fontType: .one,
//                                   fontSize: 18,
//                                   lblText: "4",
//                                   textColor: .workBlue,
//                                   alingnment: .rigth,
...
//        lblTETimeWork.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 14,
...
//        txtTETimeWork.setTextField(fontType: .one,
//                                   fontSize: 18,
//                                   lblText: "4 h",
//                                   textColor: .workBlue,
//                                   alingnment: .rigth,
...
//        lblCPBTitle.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 14,
...
//        lblCPBTotal.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 12,
//                                             lblText: "Total",
//                                             textColor: .black,
//                                             alingnment: .left,
//                                             alpha: 0.6)
...
//        txtCPBTotal.setTextField(fontType: .one,
//                                 fontSize: 16,
//                                 lblText: "$Y" ,
//                                 textColor: .blue,
...
//        lblEFTitle.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 14,
...
//        lblEFTotal.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 24,
//                                            lblText: "TOTAL",
//                                            textColor: .black,
//                                            alingnment: .left,
//                                            alpha: 0.4)
...
//        lblEFTotalByHour.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 16,
//                                                  lblText: "TOTAL/HORA",
//                                                  textColor: .black,
//                                                  alingnment: .left,
//                                                  alpha: 0.4)
...
//        lblEFTotalResult.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 24,
//                                                  lblText: "R$Y",
//                                                  textColor: .black,
//                                                  alingnment: .left,
//                                                  alpha: 0.4)
...
//        lblEFTotalByHourResult.setLabelWhithConstraints(fontType: <#UILabel.FontType#>, fontSize: 18,
